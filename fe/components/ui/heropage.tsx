            ...
            >
                <div
                    className={cn(
                        ...
                        gradient,
                        "backdrop-blur-[2px] border-2 border-blue-200/50",
...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-400/10 via-sky-300/5 to-cyan-400/10 blur-3xl" />
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-200 mb-8 md:mb-12"
                    >
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-500"
                                )}
                            >
                                {title2}
                            </span>
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            a Web2 consumer facing simple saving dApp on stack that let user create a solo or group sBTC Vault and 
                            earn BTC-Dominated yield.
                        </p>
                    </motion.div>
