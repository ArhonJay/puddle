...
export default function LandingPage() {
  ...
  // If authenticated, show home page content
  if (isAuthenticated) {
    return <HomePage />;
  }

  // Otherwise, show landing/onboarding page
  return (
    <MainLayout>
      {/* Loading Screen */}
      {isLoading && (
      ...
      <div className="min-h-screen bg-[#0a1628] text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            {/* Left Column - Welcome Card & Explore Section */}
            <div className="flex-1 w-full">
              ...
              {/* Explore Section */}
              <div className="mb-6">
                <h2 className="font-[family-name:var(--font-pixel)] text-3xl mb-6" style={{ imageRendering: 'pixelated' }}>
                  Explore more
                </h2>
            ...
            {/* Right Column - Events & User Profile */}
            <div className="w-full lg:w-80">
              {/* Events Sidebar */}
              <div className="bg-[#1e3a52] rounded-2xl p-6 border-2 border-[#2a4a62] mb-6">
